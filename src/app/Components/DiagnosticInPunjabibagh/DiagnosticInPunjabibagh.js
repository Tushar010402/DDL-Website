...
const DiagnosticInPunjabibagh = () => {
  ...
  <h1 class="text-xl text-blue-500 font-bold">📍 View on Google Maps</h1>
</a>
  <h3 class="text-xl font-semibold">📞 Call us at: +91-9810678165</h3>
  <p class="text-base text-gray-600">Timing: 8:00 AM to 6:00 PM (Monday–Saturday)</p>
