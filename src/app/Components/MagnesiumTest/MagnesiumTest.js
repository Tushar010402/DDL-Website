...
import styles from './MagnesiumTest.module.css';
            ...
            <div className={styles.H3N2MainDiv}>
                ...
                <div className={styles.H3N2BelowMainDIv}>
                    ...
                    <ul>
                        ...
                        <li>Maintaining a healthy heart rhythm and bone strength</li>
                    </ul>
                    <p>
                        Doctors may recommend a magnesium test to check for magnesium deficiency or excess.
                        Symptoms like muscle weakness, tremors, irregular heartbeat, or other health conditions
                    ...
                    <ul>
                        ...
                        <li>High magnesium levels could be linked to kidney disease, excessive magnesium
                            intake, or certain medications like antacids.</li>
                    </ul>
                    <p>
                    ...
                    <p>
                        If your levels are abnormal, your doctor may suggest dietary changes, supplements, or
                    ...
                    <p>
                        ...
                        to collect the blood sample. This service ensures comfort, safety, and accurate diagnostics
                    ...
                    <ol>
                        ...
                        <li>
                            <p><strong>What are the symptoms of low magnesium levels?</strong></p>
                            <p>Symptoms may include fatigue, muscle cramps, irregular heartbeat, and weakness.</p>
                        </li>
                        <li>
                            <p><strong>How do I prepare for a magnesium test?</strong></p>
                            <p>Generally, no special preparation or fasting is needed, but check with your doctor for
                                specific instructions.</p>
                        </li>
                        <li>
                            <p><strong>How long does it take to get magnesium test results?</strong></p>
                            <p>Results are usually available within a few hours to a day, depending on the lab.</p>
                        </li>
                        <li>
                            <p><strong>Is a magnesium test painful?</strong></p>
                            <p>The test involves a simple blood draw, which may cause minor discomfort but is generally
                                quick and safe.</p>
                        </li>
                        <li>
                            <p><strong>Can I get my magnesium test done at home?</strong></p>
                            <p>Yes, Dr. Dangs Lab offers home sample collection in Delhi and Gurgaon for a hassle-free
                                experience.</p>
                        </li>
                    </ol>
