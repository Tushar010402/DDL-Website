  ...
  return (
    <div className="bg-[#fdfbfb] text-[#1f1f1f] font-[Montserrat,'Roboto',sans-serif] overflow-x-clip">
        ...
        <div className="relative z-10 mx-auto grid max-w-[1240px] grid-cols-1 items-center gap-12 lg:grid-cols-[0.95fr_1.15fr]">
          <div className="min-w-0">
            ...
            <p className="mb-4 max-w-[580px] text-[15px] leading-[1.75] text-[#5e5e5e]">
              ...
              affects the body&apos;s hormonal balance, sleep cycle, energy
              levels, immunity, metabolism, and mental well-being. One of the
              most important hormones involved in the body&apos;s stress
              response is cortisol.
            </p>
            <p className="mb-4 max-w-[580px] text-[15px] leading-[1.75] text-[#5e5e5e]">
            ...
            <p className="mb-7 max-w-[580px] text-[15px] leading-[1.75] text-[#5e5e5e]">
              ...
              to evaluate your body&apos;s stress response and daily cortisol
              rhythm using the advanced saliva collection system.
            </p>

            <div className="mb-7 flex flex-wrap gap-2.5">
              {[
                "Non-invasive saliva based test",
                "Bio-available cortisol testing collection",
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3 text-[12.5px] font-semibold text-[#5e5e5e]">
              ...
              <span
                aria-hidden="true"
                className="h-1 w-1 rounded-full bg-[#f5d2d3]"
              />
        ...
        <div className="relative z-10 mx-auto mt-12 flex max-w-[1140px] flex-wrap items-stretch gap-4 rounded-[20px] border border-[#f5d2d3] bg-white p-5 shadow-[0_18px_40px_rgba(217,36,42,0.08)] sm:gap-5 sm:p-6">
          <div className="flex flex-1 min-w-[220px] items-center gap-3.5">
            ...
            <div className="flex flex-col">
              <strong className="text-[14px] font-bold leading-tight text-[#1f1f1f]">
                Home or lab collection
              </strong>
              <span className="mt-0.5 text-[12px] text-[#5e5e5e]">
                Same-day slots across NCR
              </span>
            </div>
          </div>
          <span
            aria-hidden="true"
            className="hidden h-[38px] w-px self-center bg-[#f5d2d3] sm:block"
          />
          <div className="flex flex-1 min-w-[220px] items-center gap-3.5">
            <span className="inline-flex h-[46px] w-[46px] flex-shrink-0 items-center justify-center rounded-[12px] border border-[#f5d2d3] bg-gradient-to-br from-[#fff4f4] to-white text-[18px] text-[#d9242a]">
      ...
      <div className="mx-auto max-w-[940px] px-5 pb-24 pt-6 sm:px-6">
        ...
        <section
          id="packages"
          className="border-b border-[#f1ebeb] pb-3.5 pt-14 sm:pt-16"
        >
          <span className="mb-2.5 inline-block text-[11.5px] font-extrabold uppercase tracking-[2.5px] text-[#d9242a]">
            Test packages
          </span>
          ...
          <p className="mb-4 text-[16.5px] leading-[1.82] text-[#3d3d3d]">
            ...
            we offer three specialised salivary cortisol testing packages using
            the advanced saliva collection system.
          </p>
          ...
          <div className="mt-6 grid gap-[18px] sm:grid-cols-2 lg:grid-cols-3">
            {PACKAGES.map((p) => (
              <article
                key={p.title}
                className="group relative rounded-[18px] border border-[#f0eaea] bg-white p-6 shadow-[0_4px_14px_rgba(0,0,0,0.04)] transition hover:-translate-y-1 hover:border-[#f5d2d3] hover:shadow-[0_16px_32px_rgba(217,36,42,0.14)]"
              >
                {/* Point count badge */}
                <span className="absolute right-4 top-4 rounded-full bg-[#d9242a] px-3 py-1 text-[11px] font-extrabold text-white shadow-[0_2px_8px_rgba(217,36,42,0.35)]">
                  {p.pointLabel}
                </span>
                ...
                <h3 className="mb-3 text-[17px] font-extrabold tracking-[-0.2px] text-[#1f1f1f] leading-snug">
                  {p.title}
                </h3>
                <p className="mb-4 text-[13.5px] leading-[1.65] text-[#5e5e5e]">
                  {p.desc}
                </p>
                <ul className="flex flex-col gap-2.5">
                  {p.points.map((pt) => (
                    <li
                      key={pt}
                      className="flex items-start gap-2.5 text-[13.5px] font-medium leading-[1.55] text-[#3f3f3f]"
                    >
                      <FaCheckCircle
                        aria-hidden="true"
                        className="mt-1 flex-shrink-0 text-[12px] text-[#d9242a]"
                      />
                      <span>{pt}</span>
                    </li>
                  ))}
        ...
        <section className="border-b border-[#f1ebeb] pb-3.5 pt-14 sm:pt-16">
          ...
          <p className="mb-4 text-[16.5px] leading-[1.82] text-[#3d3d3d]">
            ...
            <strong className="font-bold text-[#d9242a]">adrenal glands</strong>
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {CORTISOL_ROLES.map((c) => (
              <div
                key={c.text}
                className="flex items-start gap-3.5 rounded-[16px] border border-[#f0eaea] bg-white p-5 shadow-[0_4px_14px_rgba(0,0,0,0.04)] transition hover:-translate-y-1 hover:border-[#f5d2d3] hover:shadow-[0_16px_32px_rgba(217,36,42,0.14)]"
              >
                ...
                <p className="m-0 text-[14px] font-medium leading-[1.55] text-[#404040]">
                  {c.text}
                </p>
              </div>
            ))}
          ...
          <p className="mt-6 mb-3 text-[15px] leading-[1.82] text-[#5e5e5e]">
            Normally, cortisol follows a predictable daily rhythm. It rises
            rapidly after waking up, known as the{" "}
            <strong className="font-bold text-[#d9242a]">
              Cortisol Awakening Response (CAR)
            </strong>
            , and gradually declines throughout the day, reaching its{" "}
            <span className="font-bold">lowest levels at night.</span>
          </p>
          <p className="mb-3 text-[15px] leading-[1.82] text-[#5e5e5e]">
            When this rhythm becomes disrupted, it may contribute to symptoms
            such as:
          </p>
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            {DISRUPTED_SYMPTOMS.map((s) => (
              <div
                key={s.label}
                className="inline-flex items-center gap-2.5 rounded-full border border-[#efe8e8] bg-white px-5 py-3 text-[14px] font-semibold text-[#333] shadow-[0_3px_10px_rgba(0,0,0,0.03)] transition hover:-translate-y-1 hover:border-[#d9242a] hover:bg-[#fff4f4]"
              >
                <s.Icon
                  aria-hidden="true"
                  className="text-[14px] text-[#d9242a]"
                />
                <span>{s.label}</span>
              </div>
            ))}
        ...
        <section className="border-b border-[#f1ebeb] pb-3.5 pt-14 sm:pt-16">
          ...
          <p className="mb-4 text-[16.5px] leading-[1.82] text-[#3d3d3d]">
            ...
            in saliva collected at specific intervals throughout the day. Unlike
            blood cortisol testing, which reflects total cortisol, salivary
            testing evaluates{" "}
            <strong className="font-bold text-[#d9242a]">
          ...
          <p className="mt-6 text-[15px] leading-[1.82] text-[#5e5e5e]">
            The test is completely non-invasive and can be performed
            conveniently from home using saliva collection devices.
          </p>
        </section>
        ...
        <section className="border-b border-[#f1ebeb] pb-3.5 pt-14 sm:pt-16">
          ...
          <p className="mb-4 text-[16.5px] leading-[1.82] text-[#3d3d3d]">
            The Cortisol Awakening Response refers to the natural surge in
            cortisol that occurs within the first{" "}
            <strong className="font-bold text-[#d9242a]">
          ...
          <div className="mt-6 grid gap-5 sm:grid-cols-2">
            <div className="rounded-[18px] border border-[#f0eaea] bg-white p-6 shadow-[0_4px_14px_rgba(0,0,0,0.04)]">
              ...
              <ul className="m-0 flex list-none flex-col gap-3 p-0">
                {CAR_HEALTHY.map((it) => (
                  <li
                    key={it}
                    className="flex items-start gap-2.5 text-[13.5px] leading-[1.6] text-[#5e5e5e]"
                  >
                    <FaCheckCircle
                      aria-hidden="true"
                      className="mt-1 flex-shrink-0 text-[13px] text-[#d9242a]"
                    />
                    <span>{it}</span>
                  </li>
                ))}
            ...
            <div className="rounded-[18px] border border-[#f0eaea] bg-white p-6 shadow-[0_4px_14px_rgba(0,0,0,0.04)]">
              <span className="mb-4 inline-flex items-center gap-2.5 rounded-[10px] bg-[#fff4f4] px-3.5 py-2 text-[13px] font-bold text-[#d9242a]">
                <FaExclamationTriangle aria-hidden="true" /> An abnormal CAR may
                be associated with
              </span>
              <ul className="m-0 flex list-none flex-col gap-3 p-0">
                {CAR_ABNORMAL.map((it) => (
          ...
          <p className="mt-6 text-[15px] leading-[1.82] text-[#5e5e5e]">
            Our Salivary Cortisol Panel helps evaluate whether your cortisol
            pattern follows a healthy rhythm throughout the day.
          </p>
        </section>
        ...
        <section className="border-b border-[#f1ebeb] pb-3.5 pt-14 sm:pt-16">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
            {WHO_SHOULD.map((p) => (
              <div
                key={p.when}
                className="rounded-[18px] border border-[#f0eaea] bg-white p-6 shadow-[0_4px_14px_rgba(0,0,0,0.04)] transition hover:-translate-y-1 hover:shadow-[0_16px_32px_rgba(217,36,42,0.14)]"
              >
                <span className="mb-4 inline-flex items-center gap-2.5 rounded-[10px] bg-[#fff4f4] px-3.5 py-2 text-[13px] font-bold text-[#d9242a]">
                ...
                <ul className="m-0 flex list-none flex-col gap-3 p-0">
                  {p.items.map((it) => (
                    ...
                    >
                      <FaTimesCircle
                        aria-hidden="true"
                        className="mt-0.5 flex-shrink-0 text-[13px] text-[#d9242a]"
                      />
                      <span>{it}</span>
                    </li>
                  ))}
        ...
        <section className="border-b border-[#f1ebeb] pb-3.5 pt-14 sm:pt-16">
          ...
          <p className="mb-4 text-[15px] leading-[1.82] text-[#5e5e5e]">
            The panel involves collecting a total of six saliva samples at
            different times during the day. Accurate timing is extremely
            important for meaningful interpretation of the results.
          </p>
          ...
          <div className="relative mt-8 pl-1.5">
            <span
              aria-hidden="true"
              className="absolute bottom-2.5 left-[22px] top-2.5 w-[2px] bg-gradient-to-b from-[#d9242a] to-[rgba(217,36,42,0.25)]"
            />
            {COLLECTION_TIMELINE.map((p, i) => (
              <div key={p.when} className="relative mb-5 flex gap-5 last:mb-0">
                ...
                <div className="flex-1 rounded-[16px] border border-[#f0eaea] bg-white p-5 shadow-[0_4px_14px_rgba(0,0,0,0.04)] transition hover:shadow-[0_14px_30px_rgba(217,36,42,0.12)]">
                  ...
                  <p className="m-0 text-[14px] leading-[1.72] text-[#5e5e5e]">
                    {p.body}
                  </p>
                </div>
              </div>
        ...
        <section className="border-b border-[#f1ebeb] pb-3.5 pt-14 sm:pt-16">
          ...
          <p className="mb-2 text-[15px] leading-[1.82] text-[#5e5e5e]">
            To ensure reliable and accurate results, certain precautions must be
            followed before and during saliva collection.
          </p>
          ...
          <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
            {PRE_TEST.map((p) => (
              <div
                key={p.label}
                className="flex flex-col items-center gap-2.5 rounded-[14px] border border-[#f5d2d3] bg-[#fff4f4] p-5 text-center"
              >
                <span className="flex h-[44px] w-[44px] items-center justify-center rounded-[12px] bg-white text-[20px] text-[#d9242a]">
                  <p.Icon aria-hidden="true" />
                </span>
                <span className="text-[13px] font-semibold text-[#7a3438]">
                  {p.label}
                </span>
              </div>
            ))}
          ...
          <p className="mt-4 text-[15px] leading-[1.82] text-[#5e5e5e]">
            for at least{" "}
            <strong className="font-bold text-[#d9242a]">30 minutes</strong>{" "}
            before each saliva sample collection.
          </p>
          ...
          <div className="flex items-start gap-3 rounded-[14px] bg-[#fff4f4] p-4 sm:p-5">
            <FaBed
              aria-hidden="true"
              className="mt-0.5 flex-shrink-0 text-[18px] text-[#d9242a]"
            />
            <p className="m-0 text-[13.5px] leading-[1.65] text-[#7a3438]">
              Maintaining a normal sleep schedule is important. The guide
              recommends sleeping between{" "}
              <strong className="font-bold">10 PM and 12 AM</strong> and
              ensuring 7–9 hours of uninterrupted sleep before testing.
            </p>
          </div>
          ...
          <div className="flex items-start gap-3 rounded-[14px] bg-[#fff4f4] p-4 sm:p-5">
            ...
            />
            <p className="m-0 text-[13.5px] leading-[1.65] text-[#7a3438]">
              Stressful calls, emails, screen activity, or emotionally
              stimulating situations should ideally be avoided before sample
              collection, especially during the first three morning samples.
            </p>
          </div>
          ...
          <div className="rounded-[16px] border border-[#f5d2d3] bg-gradient-to-br from-[#fff4f4] to-white p-5">
            <ul className="m-0 grid list-none gap-2 p-0 sm:grid-cols-2">
              {MEDICATIONS.map((m) => (
                <li
                  key={m}
                  className="flex items-start gap-2.5 text-[13.5px] leading-[1.55] text-[#7a3438]"
                >
                  <FaTimesCircle
                    aria-hidden="true"
                    className="mt-1 flex-shrink-0 text-[12px] text-[#d9242a]"
          ...
          <p className="mt-4 text-[15px] leading-[1.82] text-[#5e5e5e]">
            The treating doctor can determine whether testing should proceed or
            be rescheduled.
          </p>
        </section>
        ...
        <section className="border-b border-[#f1ebeb] pb-3.5 pt-14 sm:pt-16">
          ...
          <p className="mb-4 text-[15px] leading-[1.82] text-[#5e5e5e]">
            The test uses a saliva collection device for hygienic and
            standardized saliva sampling.
          </p>
          ...
          <div className="mt-6 flex flex-col gap-3">
            {COLLECTION_STEPS.map((t, i) => (
              <div
                key={t}
                className="flex items-center gap-5 rounded-[14px] border border-[#f0eaea] bg-white p-4 px-5 shadow-[0_3px_12px_rgba(0,0,0,0.03)] transition hover:translate-x-2 hover:border-[#f5d2d3] hover:shadow-[0_12px_26px_rgba(217,36,42,0.12)]"
              >
                ...
                <p className="m-0 text-[14.5px] font-medium text-[#3f3f3f]">
                  {t}
                </p>
              </div>
            ))}
          ...
          <p className="mt-6 text-[14.5px] leading-[1.78] text-[#5e5e5e]">
            Proper handling helps maintain sample integrity and prevents
            contamination.
          </p>
        </section>
        ...
        <section className="border-b border-[#f1ebeb] pb-3.5 pt-14 sm:pt-16">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            <div className="rounded-[18px] border border-[#f0eaea] bg-white p-6 shadow-[0_4px_14px_rgba(0,0,0,0.04)]">
              ...
              <h3 className="m-0 mb-2 text-[16px] font-bold text-[#1f1f1f]">
                Refrigerated (2–8°C)
              </h3>
        ...
        <section className="border-b border-[#f1ebeb] pb-3.5 pt-14 sm:pt-16">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {ADVANTAGES.map((a) => (
              <div
                key={a.title}
                className="rounded-[18px] border border-[#f0eaea] bg-white p-6 shadow-[0_4px_14px_rgba(0,0,0,0.04)] transition hover:-translate-y-1 hover:shadow-[0_18px_36px_rgba(217,36,42,0.14)]"
              >
        ...
        <section className="border-b border-[#f1ebeb] pb-3.5 pt-14 sm:pt-16">
          ...
          <p className="mb-4 text-[15px] leading-[1.82] text-[#5e5e5e]">
            Dr. Dangs Lab combines advanced diagnostic expertise with
            standardized collection protocols to ensure reliable cortisol
            analysis.
          </p>
          <p className="mb-4 text-[15px] leading-[1.82] text-[#5e5e5e]">
          ...
          <div className="mt-4 grid grid-cols-1 gap-3.5 sm:grid-cols-2">
            {WHY_DDL.map((w) => (
              <div
                key={w.text}
                className="flex items-start gap-3 rounded-[14px] border border-[#f5d2d3] bg-[#fff4f4] p-5"
              >
                <w.Icon
                  aria-hidden="true"
                  className="mt-0.5 flex-shrink-0 text-[18px] text-[#d9242a]"
                />
                <p className="m-0 text-[13.5px] leading-[1.6] text-[#7a3438]">
                  {w.text}
                </p>
              </div>
            ))}
          ...
          <p className="mt-6 text-[15px] leading-[1.82] text-[#5e5e5e]">
            The test is particularly useful for individuals seeking deeper
            insight into stress physiology, energy regulation, sleep health, and
            hormonal balance.
          </p>
        </section>
        ...
        <section className="relative mx-auto my-14 overflow-hidden rounded-[24px] bg-gradient-to-br from-[#d9242a] to-[#b81e23] p-8 text-white shadow-[0_24px_50px_rgba(217,36,42,0.32)] sm:p-12">
          <span
            ...
            style={{
              background:
                "linear-gradient(120deg, rgba(255,255,255,0.16) 0%, transparent 42%), linear-gradient(300deg, rgba(255,255,255,0.07) 0%, transparent 38%)",
            }}
          />
          <div className="relative flex flex-col items-start justify-between gap-7 sm:flex-row sm:items-center">
            ...
            <Link
              href="/HomeCollection"
              className="relative z-10 inline-flex flex-shrink-0 items-center gap-2.5 rounded-full bg-white px-7 py-[15px] text-[14.5px] font-bold text-[#d9242a] shadow-[0_14px_30px_rgba(0,0,0,0.16)] transition hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(0,0,0,0.24)]"
            >
        ...
        <section className="border-b border-[#f1ebeb] pb-3.5 pt-14 sm:pt-16">
          ...
          <p className="mb-4 text-[15px] leading-[1.82] text-[#5e5e5e]">
            ...
            always visible through routine testing. Salivary cortisol testing
            offers a deeper understanding of how your body responds to stress
            throughout the day.
          </p>
          <p className="mb-4 text-[15px] leading-[1.82] text-[#5e5e5e]">
            By evaluating the Cortisol Awakening Response and daily cortisol
            rhythm, clinicians can gain valuable insights into circadian
            balance, adrenal function, and stress adaptation patterns.
          </p>
          <p className="text-[15px] leading-[1.82] text-[#5e5e5e]">
            If you are struggling with fatigue, sleep issues, chronic stress, or
            burnout-related symptoms, salivary cortisol testing in Delhi NCR at
            Dr. Dangs Lab may help provide meaningful direction for further
        ...
        <section className="relative my-12 flex flex-col gap-8 overflow-hidden rounded-[24px] border border-[#f5d2d3] bg-white p-8 shadow-[0_20px_44px_rgba(217,36,42,0.12)] sm:flex-row sm:items-center sm:justify-between sm:p-10">
          <span
            aria-hidden="true"
            className="absolute left-0 top-0 h-full w-[6px] bg-gradient-to-b from-[#d9242a] to-[#b81e23]"
          />
          <div className="relative">
            <span className="mb-2.5 inline-block text-[11px] font-extrabold uppercase tracking-[2px] text-[#d9242a]">
              Test details
            </span>
            <h3 className="m-0 mb-4 text-[22px] font-extrabold text-[#1f1f1f]">
            ...
            <ul className="m-0 flex list-none flex-col gap-3 p-0">
              <li className="flex items-center gap-3 text-[14px] font-medium text-[#555]">
                <FaFlask
                  aria-hidden="true"
                  className="w-[18px] flex-shrink-0 text-[#d9242a]"
                />
                Saliva collection
              </li>
              <li className="flex items-center gap-3 text-[14px] font-medium text-[#555]">
          ...
          <div className="relative flex flex-col gap-3">
            ...
            <Link
              href="/Feedback"
              className="inline-flex items-center justify-center gap-2 rounded-full border-[1.5px] border-[#f5d2d3] bg-white px-7 py-[15px] text-[14.5px] font-bold text-[#d9242a] transition hover:-translate-y-1 hover:border-[#d9242a] hover:bg-[#fff4f4]"
            >
              Talk to us
            </Link>
          </div>
          ...
          <div className="mt-6 flex flex-col gap-3">
            {FAQS.map((f, i) => {
              ...
              return (
                <div
                  key={f.q}
                  className={`overflow-hidden rounded-[16px] border bg-white transition ${open ? "border-[#f5d2d3] shadow-[0_14px_30px_rgba(217,36,42,0.10)]" : "border-[#ece6e6]"}`}
                >
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <span
                      aria-hidden="true"
                      className={`flex h-[30px] w-[30px] flex-shrink-0 items-center justify-center rounded-full text-[#d9242a] transition ${open ? "rotate-180 bg-gradient-to-br from-[#d9242a] to-[#b81e23] text-white" : "bg-[#fff4f4]"}`}
                    >
                      {open ? <FaMinus /> : <FaPlus />}
                    </span>
                  </button>
                  ...
                  >
                    <div className="overflow-hidden">
                      <p className="m-0 px-6 pb-6 text-[14.5px] leading-[1.82] text-[#5e5e5e]">
                        {f.a}
                      </p>
                    </div>
                  </div>
