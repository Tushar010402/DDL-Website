// src/app/Components/Biochemistry/Biochemistry.js

"use client"; // Include this if you're using Next.js App Router

import React from 'react';
import styles from './Biochemistry.module.css';
import Image from 'next/image';

const Biochemistry = () => {
  return (
    <>
      <div className={styles.BiochemistryMainPagesMainBanner}>
        <Image
          src="/PhotosAndLogos/ServiceMain2.webp"
          alt="Biochemistry"
          className={styles.BiochemistryMainPagesBackgroundImage}
          layout="fill"
          objectFit="cover"
          quality={100}
        />
        <div className={styles.BiochemistryMainPagesContentContainer}>
          <div className={styles.BiochemistryMainPagesLeftContent}>
            <h2>Biochemistry</h2>
            <p>
      ...
      <div className={styles.BiochemistryMainPagesTableContainer}>
        <h3>Biochemistry</h3>
        <table className={styles.BiochemistryMainPagesTable}>
          <thead>
    <tr>
      <th>TEST NAME</th>
      <th>METHODOLOGY</th>
