...
import RecognizationImage2 from '../../PhotosAndLogos/Recognization2.webp';
import RecognizationImage3 from '../../PhotosAndLogos/Recognization3.webp';
    ...
    return (
        <div className='RecognitionMainDiv'>
            ...
            <div className='RecognitionContent'>
                <div className='RecognitionContent-content'>
                ...
                <p>According to a recent heart health survey, India has a Cardio Vascular Disease (CVD) death rate of over 272 per one lakh population...</p>
                <h4>About the Compassionate Leader</h4>
                <p>Prof. (Dr.) Navin Dang is the Founder & Chairman of Dr. Dangs Lab...</p>
                <h4>Unique Services</h4>
                <p>Known for its advanced and high-quality diagnostic services...</p>
            </div>

            <div className='RecognitionNewSection'>
                <div className='RecognitionNewSection-1st'>
                    <h3>DR. NAVIN DANG</h3>
                ...
                <div className='RecognitionNewSection-1st' id='IdRecognitionNewSection-1st'>
                    <img src={RecognizationImage1} alt="Recognition Image 1" />
                    <img src={RecognizationImage2} alt="Recognition Image 2" />
                </div>
            </div>

            <div className="RecognitionVideoSection">
                <div className="RecognitionVideoMain">
                    <iframe
                        width="100%"
                        height="315"
                    ...
                    ></iframe>
                    <div className='RecognitionAImage3'>
                        <img src={RecognizationImage3} alt="Video Image 1" />
                        <img src={RecognizationImage4} alt="Video Image 2" />
                    </div>
                </div>
                <div className="RecognitionVideoText">
                    <p>Dr Dangs Lab is an expanded clinic that performs all types of testing all over Delhi. The Pathologists, Microbiologists, and Biochemists are highly qualified and experienced in this field. They are friendly and helpful with personalized care. The lab uses the best and the state of the art technology and provides online reports as fast as possible for the individuals. Dr Dangs Lab offers home collection services and complete health checkups for the patients.</p>
                    <p>Beta, Anti Nuclear Antibody, Biochemistry, Immunology, Dengue NS1 Antigen, Pregnancy Test, Molecular Biology, Anti Thyroglobulin, ACE, Calcium, Blood Culture, Haematology including Flowcytometry, Ceruloplasmin, Malaria Parasite/Microfilaria, Microbiology, Albumin, Cytology, Histopathology, Adenosine Deaminase, Adrenocorticotropic Hormone & APO A1</p>
                </div>
            </div>

            <div className='RecognitionsCertificateImage'>
                <img src={RecognizationImage5} alt="Image 1" className='ResearchAndTrialsImage' id='IDRecognition5' />
                <img src={RecognizationImage6} alt="Image 2" className='ResearchAndTrialsImage' id='IDRecognition5' />
            </div>

            <div className="RecognitionProfileOverview">
                <p id='RecognitionProfileOverviewIDPPPPPPP'>
                    Dr Navin Dang<br />
                    C2/1, SDA<br />
                    New Delhi-110016<br />
                ...
                <h3 className="RecognitionProfileHeading">ACADEMIC</h3>
                <div className="RecognitionProfileSection">
                    <table className="RecognitionProfileTable">
                        <thead>
                            <tr>
                                <th>Particulars</th>
                ...
                <h3 className="RecognitionProfileHeading">PROFESSIONAL EXPERIENCE</h3>
                <div className="RecognitionProfileSection">
                    <ul className="RecognitionExperienceList">
                ...
                <h3 className="RecognitionProfileHeading">Additional Responsibilities and Honours</h3>
                <div className="RecognitionProfileSection">
                    <ol className="RecognitionExperienceList">
                        <li>Honoured with the prestigious Dr. B.C. Roy National Award by the President of India in the year 2009.</li>
                ...
                <h3 className="RecognitionProfileHeading">Dr Dang’s lab Achievements</h3>
                <div className="RecognitionProfileSection">
                    <ol className="RecognitionExperienceList">
                        ...
                        <li>Dr Dangs Lab was awarded FICCI Health Care Excellence Award 2010 (Excellence in Patient Experience).</li>
                        <li>Dr Dangs Lab selected by “Business Initiative Directions” to receive the World Quality Commitment award in France (October 2014).</li>
                        <li>One of the four labs recognized by the Government of India to do HINI testing during the Swine Flu epidemic of 2009-2011.</li>
                ...
                <h3 className="RecognitionProfileHeading">RESEARCH ACTIVITIES</h3>
                ...
                <h3 className="RecognitionProfileHeading">SUPPORTED ACTIVITIES</h3>
                <div className="RecognitionProfileSection">
                    <ol className="RecognitionExperienceList" id='RecognitionExperienceListIDSAAS'>
                        <li>Ph.D. Guide</li>
