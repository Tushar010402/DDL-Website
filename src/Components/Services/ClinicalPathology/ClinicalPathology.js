...
const ClinicalPathology = () => {
  return (
    <>
      <div className='ClinicalPathology-Main-Pages-main-banner'>
        <img src={ServiceMain3} alt='ClinicalPathology' className='ClinicalPathology-Main-Pages-background-image' />
        <div className='ClinicalPathology-Main-Pages-content-container'>
          <div className='ClinicalPathology-Main-Pages-left-content'>
            <h2>Clinical Pathology</h2>
            <p>The diagnosis of disease using laboratory testing of blood and other bodily fluids, tissues, and microscopic evaluation of individual cells</p>
          </div>
        </div>
      </div>
      {/* Haematology Test Details Section */}
      <div className='ClinicalPathology-Main-Pages-table-container'>

      <h3>Clinical Pathology</h3>

  <table className='ClinicalPathology-Main-Pages-table'>
    <thead>
      <tr>
        <th>TEST NAME</th>
        <th>METHODOLOGY</th>
