...
import Corona1 from '../../PhotosAndLogos/covid-1.png';
import Corona2 from '../../PhotosAndLogos/covid-2.png';

const CoronaVirus = () => {
    return (
        <>
            <div className="corona-main">
                ...
                <div className="button-container">
                    <button className="button red">FRESH CASE OF CORONAVIRUS IN INDIA</button>
                    <button className="button red">BOOK COVID 19 HOME COLLECTION</button>
                    <button className="button red">BOOK COVID 19 DRIVE THRU</button>
                </div>
                ...
                <div className="info-section">
                    <div className="info-box">
                        ...
                        <img src={Corona2} alt="How it Spreads" />
                    </div>
                    <div className="info-box">
                        <h4>Keep Your Hands To Yourself</h4>
                        <h4>Wash Your Hands</h4>
                        <img src={Corona1} alt="Wash Your Hands" />
                    </div>
                </div>
                ...
                <div className="prevention-section">
                    ...
                    <ol>
                        <li><strong id='aaaaaa'>HANDS</strong> Wash them often</li>
                        <li><strong id='aaaaaa'>ELBOW</strong> Cough into it</li>
                        <li><strong id='aaaaaa'>FACE</strong> Don't touch it</li>
                        <li><strong id='aaaaaa'>SPACE</strong> Keep safe distance</li>
                        <li><strong id='aaaaaa'>HOME</strong> Stay if you can</li>
                    </ol>
                ...
                <div className="containment-section">
                    ...
                    <p>On 12 January 2020, the <a href="https://www.who.int">World Health Organization</a> (WHO) confirmed that a <a href="https://www.who.int/health-topics/coronavirus">novel coronavirus</a> was the cause of a respiratory illness in a cluster of people in Wuhan City, Hubei Province, China, which was reported to the WHO on 31 December 2019.</p>
                    <p>The first case of the <a href="https://en.wikipedia.org/wiki/COVID-19_pandemic_in_India">COVID-19 pandemic in India</a> was reported on 30 January 2020.</p>
                ...
                <div className="lockdown-section">
                    ...
                    <p>Further, on 24 March, the prime minister ordered a <a href="https://en.wikipedia.org/wiki/COVID-19_lockdown_in_India">nationwide lockdown</a> for 21 days, affecting the entire 1.3 billion population of India.</p>
                    <ul>
